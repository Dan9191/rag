...
COMMENT ON COLUMN article_chunks.embedding           IS 'Векторное представление текста';
...
COMMENT ON COLUMN article_chunks.chunk_metadata      IS 'Метаданные чанка: источник, название статьи, индекс чанки';
